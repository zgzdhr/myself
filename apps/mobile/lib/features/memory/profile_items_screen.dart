...
class _ProfileItemsScreenState extends State<ProfileItemsScreen> {
  late Future<List<ProfileItem>> _itemsFuture;

  @override
  void initState() {
    super.initState();
    _itemsFuture = widget.database.getActiveProfileItems();
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: FutureBuilder<List<ProfileItem>>(
        future: _itemsFuture,
              ...
              for (final item in items)
                Card(
                  child: ListTile(
                    ...
                    subtitle: Text('来源：${item.sourceRawInputId}'),
                    trailing: Wrap(
                      spacing: 8,
                      children: [
                        TextButton(
